...
const COUNTRIES = ['Singapore', 'United Kingdom', 'United States', 'Lithuania', 'Australia', 'India', 'Hong Kong', 'Canada', 'Netherlands', 'Germany', 'France', 'Japan', 'Korea', 'Vietnam', 'UAE','Mexico', 'Nepal'];
